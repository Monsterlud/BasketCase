...
class BasketCaseRepositoryImpl(
    ...
    /** PantryItemEntity */
    override suspend fun insertPantryItem(pantryItem: PantryItemEntity) = localDataSource.insertPantryItem(pantryItem)

    override suspend fun insertAllPantryItems(pantryItem: List<PantryItemEntity>) = localDataSource.insertAllPantryItems(pantryItem)

    override suspend fun updatePantryItem(pantryItem: PantryItemEntity) = localDataSource.updatePantryItem(pantryItem)

    override suspend fun deletePantryItem(pantryItem: PantryItemEntity) = localDataSource.deletePantryItem(pantryItem)
    ...
    override fun getPantryItemById(id: Long): Flow<PantryItemEntity> = localDataSource.getPantryItemById(id)
    ...
    override suspend fun insertAllMarkets(markets: List<MarketEntity>) = localDataSource.insertAllMarkets(markets)
    ...
    override suspend fun insertItemToPurchase(itemToPurchase: ItemToPurchaseEntity) = localDataSource.insertItemToPurchase(itemToPurchase)
    ...
    override suspend fun updateItemToPurchase(itemToPurchase: ItemToPurchaseEntity) = localDataSource.updateItemToPurchase(itemToPurchase)

    override suspend fun deleteItemToPurchase(itemToPurchase: ItemToPurchaseEntity) = localDataSource.deleteItemToPurchase(itemToPurchase)

    override fun deleteAllItemsToPurchase() = localDataSource.deleteAllItemsToPurchase()

    override fun getAllItemsToPurchase(): Flow<List<ItemToPurchaseEntity>> = localDataSource.getAllItemsToPurchase()

    override fun getItemToPurchaseById(id: Long): Flow<ItemToPurchaseEntity> = localDataSource.getItemToPurchaseById(id)

    /** ShoppingListEntity */
    override suspend fun insertShoppingList(shoppingList: ShoppingListEntity) = localDataSource.insertShoppingList(shoppingList)
    ...
    override suspend fun updateShoppingList(shoppingList: ShoppingListEntity) = localDataSource.updateShoppingList(shoppingList)

    override suspend fun deleteShoppingList(shoppingList: ShoppingListEntity) = localDataSource.deleteShoppingList(shoppingList)

    override fun deleteAllShoppingLists() = localDataSource.deleteAllShoppingLists()

    override fun getAllShoppingListsWithItems(): Flow<List<ShoppingListWithItems>> = localDataSource.getAllShoppingListsWithItems()

    override fun getShoppingListByIdWithItems(id: Long): Flow<ShoppingListWithItems> = localDataSource.getShoppingListByIdWithItems(id)
    ...
    override fun deleteAllShoppingListItemAssociations() = localDataSource.deleteAllShoppingListItemAssociations()
    ...
    override suspend fun isItemInShoppingList(
        ...
        localDataSource.isItemInShoppingList(
            listId,
            itemId,
        )
